...
namespace Order.Common
{
    ...
    public static class SQLiteHelper
    {
        ...
        public static string connStr = "Data Source=" + AppDomain.CurrentDomain.BaseDirectory + "CDCompanyData.sqlite"; //ElandSalseDailyReport_qianduan   ElandSalseDailyReport1
